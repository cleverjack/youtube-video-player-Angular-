...
class Installer {
	 ...
	 * @var array
	 */
    private $dirs = array('/application', '/assets/avatars', '/application/storage', '/application/storage/app', '/application/storage/framework', '/application/storage/logs', '/assets/css/custom-stylesheets', '/application/resources/lang');
